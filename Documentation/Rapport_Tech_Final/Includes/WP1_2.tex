...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \par\small Photograhie Téléphone
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
        \centering
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \par\small Photograhie interieure
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
        \centering
...
Après réception de notre PCB nous l'avons monté et soudé, avec le matériel que nous avion personnellement, et nous avons effectué des tests de tensio direction.
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \par\small Vue du haut du PCB après reception
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/WP1_2/Tache_8/PCB_BACK.png}
        \par\small Vue du bas du PCB après reception
    \end{minipage}
...
Nous avons aussi réalisé un schéma électrique de notre système, même la réalisation du PCB, ce qui était un objectif plus que final.
\\

Sur le plan personnel je me suis beaucoup épanoui dans ce WP, j'était au centre de work package, au début une sorte de mini préssion
pour ne pas décevoir mon chef de projet, mais cela s'est plutot bien déroulé.
\\

Le matériel à été le plus gros problème de ce WP, nous avons eu beaucoup de problèmes de commande, nous avons du tuiliser, ou meme commander 
par nous meme le matériel nécessaire pour la réalisation de notre projet, ce qui a engendré des retards dans notre planning,
